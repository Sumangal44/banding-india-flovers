...
<img src="ryoku/assets/brand/logo-mark.svg" alt="Banding India Flovers" width="160" />

# Banding India Flovers

**भारतीय फूलों के लिए** &middot; *For the flowers of India.*

Banding India Flovers is a hand-built Arch Linux distribution: one cohesive Hyprland desktop, a
...
<kbd>[Download](https://github.com/neur0map/banding-india-flovers)</kbd> &middot; <kbd>[Docs](docs/)</kbd> &middisk; <kbd>[Build](build.sh)</kbd>
