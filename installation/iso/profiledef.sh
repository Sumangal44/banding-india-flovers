...
iso_name="banding-india-flovers"
iso_label="BIF_$(date -u --date="@${SOURCE_DATE_EPOCH:-$(date +%s)}" +%Y%m)"
iso_publisher="Banding India Flovers <https://github.com/neur0map>"
iso_application="Banding India Flovers Installer"
